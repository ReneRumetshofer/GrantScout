...
### Install Software
* Docker (e.g. [Docker Desktop](https://www.docker.com/get-started/) for Windows and Linux or [Docker Engine](https://docs.docker.com/engine/install/) for Linux)
...
* Database (only with Docker)
  * IntelliJ IDEA: open _[docker-compose.yml](docker-compose.yml)_ and press on the play button in the line with `postgres`
  * VS Code: ?
